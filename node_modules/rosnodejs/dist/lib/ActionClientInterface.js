...
var ActionClientInterface = function (_EventEmitter) {
  _inherits(ActionClientInterface, _EventEmitter);

  function ActionClientInterface(options) {
    _classCallCheck(this, ActionClientInterface);

    var _this = _possibleConstructorReturn(this, (ActionClientInterface.__proto__ || Object.getPrototypeOf(ActionClientInterface)).call(this));
  ...
  _createClass(ActionClientInterface, [{
    key: '_handleStatus',
