...
var MasterApiClient = function () {
  ...
  _createClass(MasterApiClient, [{
    ...
    value: function getPublishedTopics(callerId, subgraph, options) {
      var _this8 = this;

      var data = [callerId, subgraph];
      return new Promise(function (resolve, reject) {
        _this8._call('getPublishedTopics', data, function (data) {
          return resolve({
            topics: data[2].map(function (topic) {
              return {
    ...
    key: 'getTopicTypes',
    value: function getTopicTypes(callerId, options) {
      var _this9 = this;

      var data = [callerId];
      return new Promise(function (resolve, reject) {
        _this9._call('getTopicTypes', data, function (data) {
          return resolve({
            topics: data[2].map(function (topic) {
              return {
                name: topic[0], type: topic[1]
    ...
    value: function getSystemState(callerId, options) {
      ...
      var data = [callerId];
      return new Promise(function (resolve, reject) {
        _this10._call('getSystemState', data, function (data) {
          return resolve({
    ...
    value: function getUri(callerId, options) {
      ...
      var data = [callerId];
      return new Promise(function (resolve, reject) {
        _this11._call('getUri', data, resolve, reject, options);
      });
    }
  }, {
    key: 'lookupService',
    value: function lookupService(callerId, service, options) {
      ...
      return new Promise(function (resolve, reject) {
        _this12._call('lookupService', data, resolve, reject, options);
      });
    }
  }]);
